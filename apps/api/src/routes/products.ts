...
const createProductSchema = z.object({
  ...
  category: z.enum(['GROCERIES', 'DAIRY', 'VEGETABLES', 'FRUITS', 'BEVERAGES', 'SNACKS', 'PERSONAL_CARE', 'HOUSEHOLD', 'OTHER']),
  unitOfMeasurement: z.enum(['KG', 'GRAM', 'LITER', 'ML', 'PIECE', 'PACK', 'BOX']),
