...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'regression-comprehensive',
      testMatch: /regression-testing\.spec\.ts/,
      use: { ...devices['Desktop Chrome'] },
    },
    {
      name: 'regression-api',
    ...
    },
    {
      ...
      use: { 
        ...
        hasTouch: true  // Enable touch support for mobile performance tests
      },
    },
    {
      name: 'regression-security',
      testMatch: /security-regression\.spec\.ts/,
      use: { ...devices['Desktop Chrome'] },
    },
